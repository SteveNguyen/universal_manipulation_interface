"""
python scripts_slam_pipeline/03_batch_slam_hero13.py -i data_workspace/fold_cloth_20231214/demos
"""
# %%
import sys
import os
...
def main(input_dir, map_path, settings_file, docker_image, num_workers, max_lost_frames, timeout_multiple, no_docker_pull):
